...
model = NN(hidden_size=20,num_layers=2,batch_size=batch_size,no_classes=2, device="cpu")
...
batch_size=batch_size,n_epochs=epochs,device = 'cpu', trial_name = "known_vs_unknown_batch64_lr_10e3_wd10e4")
