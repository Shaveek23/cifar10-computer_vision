...
model = VGGLikeParametrized(n_output=12)
...
train_one_vs_one(12, model, opt, criterion, train_transform, test_transform, batch_size=32, n_epochs=100, device='cuda', trial_name='conv2d_vgglikeparametrized')
