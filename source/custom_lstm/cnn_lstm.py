...
class NN(ImageClassificationBase):
    def __init__(self,input_size=1,no_classes=12, hidden_size=11,num_layers =1,batch_size = 64) -> None:
        super().__init__()
        self.lstm = nn.LSTM(input_size, hidden_size, num_layers,batch_first = True)
        self.hidden = self._init_hidden(batch_size, hidden_size, 1, num_layers)
    ...
    def _init_hidden(self, batch_size, hidden_size, num_directions, num_layers):
